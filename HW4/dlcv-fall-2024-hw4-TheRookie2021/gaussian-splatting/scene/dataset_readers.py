...
def readColmapSceneInfo(path, images, depths, eval, train_test_exp,  model_path, llffhold=8):
    print(model_path)
    try:
    ...
    if not os.path.exists(ply_path):
        ...
        try:
            ...
            try:
                ...
                print("===============pcd===============")
                xyz, rgb, _ = fetchPly("HW4/round3/point_cloud/iteration_150000/point_cloud.ply")
